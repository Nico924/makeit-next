...
import styleIdentifiers from './thanksPagePartners.scss';
...
export type ThanksPagePartnersProps = StateProps & DispatchProps & OwnProps;

const ThanksPagePartners = (props: ThanksPagePartnersProps) => {
  ...
  return (
    <div className={styles('thanks-page-partners')}>
      <section className={styles('first')}>
        <div className={styles('container')}>
          <div className={styles('left')}>
            <div className={styles('section_heading')}>
              <div className={styles('title', 'white')}>
                <TextItem path="partners.thankYouPage.title" isHtml />
              </div>
              <div className={styles('text', 'white')}>
                <TextItem path="partners.thankYouPage.text" isHtml />
              </div>
              ...
              <CustomButton
                ...
                color="red"
                label="partners.thankYouPage.button"
...
export default ThanksPagePartners;
